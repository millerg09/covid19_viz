...
print (type(new_case_list))

### version 2 plots
#chart_title = ('Daily New Cases: %s' % selected)
#fig = px.line(fd, x=num_list, y=avg_nc, title=chart_title)

#chart_title = ('Daily New Cases: %s' % selected)
#fig = px.line(x=date_list, y=new_case_list, title=chart_title)
